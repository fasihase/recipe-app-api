...
class PublicUserApiTest(TestCase):
    ...
    def test_password_too_short(self):
        ...
        payload = {'email': 'test@email.com', 'password': 'pwd'}
        response = self.client.post(CREATE_USER_URL, payload)
    ...
    def test_craete_token_for_user(self):
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='test@email.com', password='testpasss')
    ...
    def test_retrieve_user_unauthorized(self):
        """Test that authentocation is required for user"""
...
class PrivateUserApiTest(TestCase):
    ...
    def test_update_user_profile(self):
        ...
        self.user.refresh_from_db()  # Update user from db with latest value
